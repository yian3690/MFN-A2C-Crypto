...
def main() -> None:
    ...
    output_csv = cfg.EXPERIMENT_RESULTS / f"experiment2_4h_{cfg.STEP_TAG}_comparison.csv"
    ...
    table.to_csv(cfg.EXPERIMENT_RESULTS / f"experiment2_4h_{cfg.STEP_TAG}_table.csv", index=False)
